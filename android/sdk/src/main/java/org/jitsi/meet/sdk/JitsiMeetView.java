...
public class JitsiMeetView extends FrameLayout {
    ...
    public void toggleCameraFacingMode() {
        ToggleCameraModule toggModule = ReactInstanceManagerHolder.getNativeModule(ToggleCameraModule.class);
    
        try {
            toggModule.toggleCameraFacingMode();
        } catch (RuntimeException re) {
            JitsiMeetLogger.e(re, "Failed to fetch mode");
        }
    }
    /**s
